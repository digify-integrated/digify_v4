    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        <style>
            ...
            [data-bs-theme="dark"] body {
                background-image: url('./assets/images/auth/bg1-dark.jpg');
            }
        </style>
            ...
            <div class="d-flex flex-column flex-center text-center p-10">       
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <div class="mb-3">
                            <img src="assets/images/auth/404-error.png" class="mw-100 mh-300px theme-light-show" alt=""/>
                            <img src="assets/images/auth/404-error-dark.png" class="mw-100 mh-300px theme-dark-show" alt=""/>
                        </div>
                        <div class="mb-0">
